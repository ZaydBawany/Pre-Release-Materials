#question 1 Lower case symbols are not accepted. E.g. if you enter 'q' it is not recognised as 'Q'. Fix this.
...
#changed code
    def __GetSymbolFromUser(self):
        ...
        while not Symbol in self.__AllowedSymbols:
            Symbol = input("Enter symbol: ").upper() # convert the input into an uppercase value no matter what it is
        return Symbol
#changed code
