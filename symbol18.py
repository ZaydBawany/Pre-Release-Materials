...
#changes start
    def AttemptPuzzle(self):
        ...
        while not Finished:
            ...
            self.__SymbolsLeft -= 33 # for testing purposes
            print(self.__SymbolsLeft, "symbols left") #for testing purposes
            ...
            if self.__SymbolsLeft == 5:
                quit = input("Would you like to quit? enter Y or y if so...")
                if quit == "Y" or quit == "y":
                    print("Thanks for playing!")
                    Finished = True
                    pass
            elif self.__SymbolsLeft == 0:#symbols left acts as turns
                Finished = True
        print()
        self.DisplayPuzzle()
        print()
