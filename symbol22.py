        ...
        while not Finished:
            ...
            while not Valid:
                try:
                    ...
                    if 1 <= Row <= self.__GridSize:  # Check if Row is within the valid range
                        Valid = True
                    else:
                        print("Row number is out of range. Please enter a valid row number.")
                except ValueError:
            ...
            while not Valid:
                try:
                    ...
                    if 1 <= Column <= self.__GridSize:  # Check if Column is within the valid range
                        Valid = True
                    else:
                        print("Column number is out of range. Please enter a valid column number.")
                except ValueError:
                    print("Invalid input. Please enter a valid column number.")
                    
            Symbol = self.__GetSymbolFromUser()
            self.__SymbolsLeft -= 1
            print(self.__SymbolsLeft, "symbols left")
