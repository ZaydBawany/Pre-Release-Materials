...
if __name__ == "__main__":
    ...
    # The following lines provide an option for the user to view a summary of the rules and how each symbol works.
    view_rules = input("Would you like to view the game rules? (yes/no): ").lower()
    if view_rules == "yes":
        print("\nRules of the Puzzle Game:")
        print("- The game grid has some blocked cells, denoted by '@'.")
        print("- Your goal is to place symbols (Q, T, X) on the grid to form patterns.")
        print("- Q Pattern: \n QQQ \n Q  \n Q  ")
        print("- T Pattern: \n TTT \n  T \n  T ")
        print("- X Pattern: \nX   X\n  X \nX   X")
